...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final String KEY_QUESTION_COUNT = "keyQuestionsLeft";
    ...
    private void showSolution(){
        ...
        if(currentQuestion.getAnswerNum()==1){
            rb1.setTextColor(Color.GREEN);
            textViewQuestion.setText("Answer A is correct");
        }else if(currentQuestion.getAnswerNum()==2){
            rb2.setTextColor(Color.GREEN);
            textViewQuestion.setText("Answer B is correct");
        }else if(currentQuestion.getAnswerNum()==3) {
